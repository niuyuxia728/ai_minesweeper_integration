...
const mockLeaderboard: LeaderboardEntry[] = [
  ...
  { id: '4', username: 'QuickClick', time: 71, date: new Date('2024-01-12'), difficulty: 'easy' },
  { id: '5', username: 'SafePlayer', time: 89, date: new Date('2024-01-11'), difficulty: 'easy' },
  { id: '6', username: 'FlagMaster', time: 94, date: new Date('2024-01-10'), difficulty: 'easy' },
  { id: '7', username: 'CoolGamer', time: 105, date: new Date('2024-01-09'), difficulty: 'easy' },
  { id: '8', username: 'ProSweeper', time: 112, date: new Date('2024-01-08'), difficulty: 'easy' },
];
